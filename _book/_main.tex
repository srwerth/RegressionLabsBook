...
\hypersetup{
  pdftitle={Linear Regression in Stata and R},
...
\addcontentsline{toc}{subsection}{Load your data}
...
\addcontentsline{toc}{subsubsection}{Bar plots}
...
\addcontentsline{toc}{subsubsection}{View the first 10 rows of your data set.}
...
\addcontentsline{toc}{paragraph}{\texttt{hist()} to create a histogram in base R}
